...
public class MultipleDecision extends Decision {

	public MultipleDecision(String question, String auswahlText, String falscheAuswahlText) {
	...
	public String toString() {
		...
		result.append("ENTSCHEIDUNG:").append(TextUtil.endl);
		if (auswahlText != null) {
