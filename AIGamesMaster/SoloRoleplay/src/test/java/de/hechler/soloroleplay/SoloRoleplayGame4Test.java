...
public class SoloRoleplayGame4Test {
	...
	public void setup() throws ValidationException {
		soloText = TextUtil.readResource("beispiel4_solo.txt", StandardCharsets.ISO_8859_1);
	...
	@Test
	public void testExampleSolo4Output() {
		String expected = TextUtil.readResource("expected4_solotext_output.txt", StandardCharsets.ISO_8859_1);
	...
	@Test
	public void testExampleSolo4() {
		UserInput input = new UserInput(null, getClass().getResourceAsStream("/solo4_user_input.txt"), StandardCharsets.ISO_8859_1.name());
		...
		try {
			...
			String expected = TextUtil.readResource("expected4_solorun_output.txt", StandardCharsets.ISO_8859_1);
			expected = TextUtil.makeEndl(expected);
