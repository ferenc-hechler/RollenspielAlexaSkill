...
public class SoloRoleplayGame3Test {
	...
	public void setup() throws ValidationException {
		soloText = TextUtil.readResource("beispiel3_solo.txt", StandardCharsets.ISO_8859_1);
	...
	@Test
	public void testExampleSolo3Output() {
		String expected = TextUtil.readResource("expected3_solotext_output.txt", StandardCharsets.ISO_8859_1);
	...
	@Test
	public void testExampleSolo3a() {
		UserInput input = new UserInput(null, getClass().getResourceAsStream("/solo3_user_input.txt"), StandardCharsets.ISO_8859_1.name());
		...
		try {
			...
			String expected = TextUtil.readResource("expected3_solorun_output.txt", StandardCharsets.ISO_8859_1);
			expected = TextUtil.makeEndl(expected);
