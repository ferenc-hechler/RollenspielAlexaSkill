...
public class SoloRoleplayGameTest {
	...
	public void setup() throws ValidationException {
		soloText = TextUtil.readResource("beispiel_solo.txt", StandardCharsets.ISO_8859_1);
	...
	@Test
	public void testExampleSolo() {
		UserInput input = new UserInput(null, getClass().getResourceAsStream("/solo_user_input.txt"), StandardCharsets.ISO_8859_1.name());
		...
		try {
			...
			String expected = TextUtil.readResource("expected_solorun_output.txt", StandardCharsets.ISO_8859_1);
			expected = TextUtil.makeEndl(expected);
