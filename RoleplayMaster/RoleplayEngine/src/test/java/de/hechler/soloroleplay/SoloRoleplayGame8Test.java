...
public class SoloRoleplayGame8Test {
	...
	public void setup() throws ValidationException {
		soloText = TextUtil.readResource("beispiel8_solo.txt", StandardCharsets.ISO_8859_1);
	...
	@Test
	public void testExampleSolo8Output() {
		String expected = TextUtil.readResource("expected8_solotext_output.txt", StandardCharsets.ISO_8859_1);
	...
	@Test
	public void testExampleSolo8() {
		UserInput input = new UserInput(null, getClass().getResourceAsStream("/solo8_user_input.txt"), StandardCharsets.ISO_8859_1.name());
		...
		try {
			...
			String expected = TextUtil.readResource("expected8_solorun_output.txt", StandardCharsets.ISO_8859_1);
			expected = TextUtil.makeEndl(expected);
