...
public class SoloRoleplayGame7Test {
	...
	public void setup() throws ValidationException {
		soloText = TextUtil.readResource("beispiel7_solo.txt", StandardCharsets.ISO_8859_1);
	...
	@Test
	public void testExampleSolo7Output() {
		String expected = TextUtil.readResource("expected7_solotext_output.txt", StandardCharsets.ISO_8859_1);
	...
	@Test
	public void testExampleSolo7() {
		UserInput input = new UserInput(null, getClass().getResourceAsStream("/solo7_user_input.txt"), StandardCharsets.ISO_8859_1.name());
		...
		try {
			...
			String expected = TextUtil.readResource("expected7_solorun_output.txt", StandardCharsets.ISO_8859_1);
			expected = TextUtil.makeEndl(expected);
